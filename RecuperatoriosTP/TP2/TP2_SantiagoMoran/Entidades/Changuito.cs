...
namespace Entidades_2017 {
    ...
    public sealed class Changuito {
        ...
        public static Changuito operator +(Changuito c, Producto p) { 
            ...
            if (auxChanguito._productos.Count < auxChanguito._espacioDisponible) {

                foreach (Producto v in auxChanguito._productos) {
        ...
        public static Changuito operator -(Changuito c, Producto p) {
            ...
            foreach (Producto v in auxChanguito._productos) {
                ...
                if (v == p) {
                    ...
                    auxChanguito._productos.RemoveAt(index);
                    break;
